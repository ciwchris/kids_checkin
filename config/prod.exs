...
config :kids_checkin, KidsCheckin.Endpoint,
  ...
  url: [scheme: "https", host: "somaspokane.herokuapp.com", port: 443],
...
# start per endpoint:
#
#     config :kids_checkin, KidsCheckin.Endpoint, server: true
#
# You will also need to set the application root to `.` in order
# for the new static assets to be served after a hot upgrade:
#
#     config :kids_checkin, KidsCheckin.Endpoint, root: "."
